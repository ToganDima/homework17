...
import ContactsArray from "../components/InitialContactsArray";
...
function ContactList() {
  ...
  function getFilteredContacts() {
    return ContactsArray.filter((contactObj) => {
      let fullName = (contactObj.firstName + " " + contactObj.lastName).toLowerCase();
      if ((search === "" || fullName.includes(search) || contactObj.phone.includes(search)) && filters.includes(contactObj.gender)) { return contactObj };
    });
  }
